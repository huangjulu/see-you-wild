...
const typeOptions = [
  { value: "camping", label: "野營私廚" },
  { value: "hot-spring", label: "野溪溫泉" },
  { value: "sup", label: "SUP 立槳" },
];
...
describe("EventSearchBar", () => {
  ...
  it("選擇活動類型觸發 onTypeChange（pill），回傳 value 而非 label", async () => {
