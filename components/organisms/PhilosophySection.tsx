    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="space-y-8">
          <p
            className="reveal-up text-sm tracking-[0.3em] uppercase"
            style={{ color: "#A69B8D" }}
          >
            Our Philosophy
          </p>
          <h2
            className="reveal-up text-4xl md:text-5xl lg:text-6xl leading-tight"
            style={{
          ...
          <p
            className="reveal-up text-lg leading-relaxed"
